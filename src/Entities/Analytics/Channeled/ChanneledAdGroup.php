...
#[ORM\Index(columns: ['campaign_id'], name: 'idx_channeled_ad_groups_campaign_id_idx')]
...
#[ORM\Index(columns: ['channeledAccount_id', 'channeledCampaign_id'], name: 'idx_channeled_ad_groups_channeledAccount_id_channeledCampaign_id_idx')]
#[ORM\Index(columns: ['platformId', 'channel', 'channeledAccount_id', 'channeledCampaign_id'], name: 'idx_channeled_ad_groups_platformId_channel_channeledAccount_id_channeledCampaign_id_idx')]
