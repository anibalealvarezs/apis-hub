<?php
    ...
    #[ORM\Index(name: 'idx_channeled_campaigns_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_channeled_campaigns_channel_idx', columns: ['channel'])]
    #[ORM\Index(name: 'idx_channeled_campaigns_platform_channel_idx', columns: ['platform_id', 'channel'])]
