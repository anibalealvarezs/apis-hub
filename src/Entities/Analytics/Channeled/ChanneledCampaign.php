...
#[ORM\Index(columns: ['channel'], name: 'idx_channeled_campaigns_idx')]
#[ORM\Index(columns: ['platformId', 'channel'], name: 'idx_channeled_campaigns_platformId_channel_idx')]
#[ORM\Index(columns: ['channeledAccount_id'], name: 'idx_channeled_campaigns_channeledAccount_id_idx')]
#[ORM\Index(columns: ['campaign_id'], name: 'idx_channeled_campaigns_idx')]
