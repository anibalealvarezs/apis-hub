...
#[ORM\Index(columns: ['code', 'platformId', 'channel'], name: 'idx_channeled_discounts_code_platformId_channel_idx')]
#[ORM\Index(columns: ['platformId', 'channel'], name: 'idx_channeled_discounts_platformId_channel_idx')]
#[ORM\Index(columns: ['code', 'channel'], name: 'idx_channeled_discounts_email_channel_idx')]
