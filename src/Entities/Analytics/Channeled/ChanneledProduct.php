<?php
    ...
    #[ORM\Index(name: 'idx_channeled_products_platform_id_channel_idx', columns: ['platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_products_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_channeled_products_sku_idx', columns: ['sku'])]
    #[ORM\Index(name: 'idx_channeled_products_platform_created_at_idx', columns: ['platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_products_pid_sku_idx', columns: ['platform_id', 'sku'])]
    #[ORM\Index(name: 'idx_channeled_products_pid_created_idx', columns: ['platform_id', 'platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_products_sku_created_idx', columns: ['sku', 'platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_products_full_idx', columns: ['platform_id', 'sku', 'platform_created_at'])]
