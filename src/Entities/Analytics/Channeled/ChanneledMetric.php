<?php
    ...
    #[ORM\Index(name: 'idx_channeled_metrics_metric_id_idx', columns: ['metric_id'])]
    #[ORM\Index(name: 'idx_channeled_metrics_metric_created_idx', columns: ['metric_id', 'platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_metrics_platform_channel_idx', columns: ['platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_metrics_full_idx', columns: ['platform_id', 'channel', 'metric_id'])]
    #[ORM\Index(name: 'idx_channeled_metrics_platform_created_idx', columns: ['platform_id', 'channel', 'platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_metrics_created_at_idx', columns: ['platform_created_at'])]
