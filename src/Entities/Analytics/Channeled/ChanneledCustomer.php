<?php
    ...
    #[ORM\Index(name: 'idx_channeled_customers_full_idx', columns: ['email', 'platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_customers_pid_channel_idx', columns: ['platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_customers_email_channel_idx', columns: ['email', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_customers_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_channeled_customers_platform_created_at_idx', columns: ['platform_created_at'])]
    #[ORM\Index(name: 'idx_channeled_customers_email_idx', columns: ['email'])]
