...
#[ORM\Index(columns: ['name', 'platformId', 'channel', 'type'], name: 'idx_channeled_accounts_platformId_channel_type_idx')]
#[ORM\Index(columns: ['name', 'platformId', 'channel'], name: 'idx_channeled_accounts_platformId_channel_idx')]
...
#[ORM\Index(columns: ['name', 'channel', 'type'], name: 'idx_channeled_accounts_idx')]
#[ORM\Index(columns: ['name', 'channel'], name: 'idx_channeled_accounts_idx')]
...
#[ORM\Index(columns: ['name', 'type'], name: 'idx_channeled_accounts_idx')]
#[ORM\Index(columns: ['name'], name: 'idx_channeled_accounts_idx')]
#[ORM\Index(columns: ['account_id'], name: 'idx_channeled_accounts_idx')]
