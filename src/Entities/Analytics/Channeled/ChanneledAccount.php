...
#[ORM\Index(columns: ['name', 'platformId', 'channel', 'type'], name: 'idx_channeled_accounts_name_platformId_channel_type_idx')]
#[ORM\Index(columns: ['name', 'platformId', 'channel'], name: 'idx_channeled_accounts_name_platformId_channel_idx')]
#[ORM\Index(columns: ['platformId', 'channel', 'type'], name: 'idx_channeled_accounts_platformId_channel_type_idx')]
#[ORM\Index(columns: ['platformId', 'channel'], name: 'idx_channeled_accounts_platformId_channel_idx')]
#[ORM\Index(columns: ['name', 'channel', 'type'], name: 'idx_channeled_accounts_email_channel_type_idx')]
#[ORM\Index(columns: ['name', 'channel'], name: 'idx_channeled_accounts_email_channel_idx')]
#[ORM\Index(columns: ['platformId', 'type'], name: 'idx_channeled_accounts_platformId_type_idx')]
#[ORM\Index(columns: ['platformId'], name: 'idx_channeled_accounts_platformId_idx')]
#[ORM\Index(columns: ['platformCreatedAt'], name: 'idx_channeled_accounts_platformCreatedAt_idx')]
#[ORM\Index(columns: ['name', 'type'], name: 'idx_channeled_accounts_name_type_idx')]
#[ORM\Index(columns: ['name'], name: 'idx_channeled_accounts_name_idx')]
#[ORM\Index(columns: ['account_id'], name: 'idx_channeled_accounts_account_id_idx')]
