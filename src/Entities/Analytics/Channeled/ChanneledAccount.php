<?php
    ...
    #[ORM\Index(name: 'idx_cha_name_channel_type_idx', columns: ['name', 'channel', 'type'])]
    #[ORM\Index(name: 'idx_cha_name_channel_idx', columns: ['name', 'channel'])]
    #[ORM\Index(name: 'idx_cha_platform_id_type_idx', columns: ['platform_id', 'type'])]
    #[ORM\Index(name: 'idx_cha_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_cha_platform_created_at_idx', columns: ['platform_created_at'])]
    #[ORM\Index(name: 'idx_cha_name_type_idx', columns: ['name', 'type'])]
    #[ORM\Index(name: 'idx_cha_name_idx', columns: ['name'])]
    #[ORM\Index(name: 'idx_cha_account_id_idx', columns: ['account_id'])]
