<?php
    ...
    #[ORM\Index(name: 'idx_channeled_ads_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_channeled_ads_channel_idx', columns: ['channel'])]
    #[ORM\Index(name: 'idx_channeled_ads_platform_channel_idx', columns: ['platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_ads_channeled_ad_group_id_idx', columns: ['channeled_ad_group_id'])]
    #[ORM\Index(name: 'idx_channeled_ads_channeled_campaign_id_idx', columns: ['channeled_campaign_id'])]
    #[ORM\Index(name: 'idx_channeled_ads_campaign_ad_group_idx', columns: ['channeled_campaign_id', 'channeled_ad_group_id'])]
    #[ORM\Index(name: 'idx_channeled_ads_full_idx', columns: ['platform_id', 'channel', 'channeled_campaign_id', 'channeled_ad_group_id'])]
