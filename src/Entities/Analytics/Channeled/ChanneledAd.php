...
#[ORM\Index(columns: ['platformId', 'channel'], name: 'idx_channeled_ads_channel_idx')]
...
#[ORM\Index(columns: ['channeledCampaign_id', 'channeledAdGroup_id'], name: 'idx_channeled_ads_channeledCampaign_id_channeledAdGroup_id_idx')]
#[ORM\Index(columns: ['platformId', 'channel', 'channeledCampaign_id', 'channeledAdGroup_id'], name: 'idx_channeled_ads_platformId_channel_channeledCampaign_id_channeledAdGroup_id_idx')]
