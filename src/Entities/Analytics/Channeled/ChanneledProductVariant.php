<?php
    ...
    #[ORM\Index(name: 'idx_channeled_product_variants_platform_id_channel_idx', columns: ['platform_id', 'channel'])]
    #[ORM\Index(name: 'idx_channeled_product_variants_platform_id_idx', columns: ['platform_id'])]
    #[ORM\Index(name: 'idx_channeled_product_variants_platform_created_at_idx', columns: ['platform_created_at'])]
