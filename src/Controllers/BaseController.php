<?php
    ...
    abstract class BaseController
    {
         ...
         */
        protected const array CRUD_TOP_LEVEL_PARAMS = [
         ...
         */
        protected const array CONTROLLER_ONLY_PARAMS = ['rawData', 'hideFields'];

        protected const int DEFAULT_LIMIT = 100;
        protected const int HARD_MAX_LIMIT = 50000;
        protected const int DOCS_FORCED_LIMIT = 10;
