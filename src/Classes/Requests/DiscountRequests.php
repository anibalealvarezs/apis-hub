...
class DiscountRequests implements RequestInterface
{
    ...
    public static function getListFromShopify(string $createdAtMin = null, string $createdAtMax = null, object $filters = null): Response
    {
        ...
        return self::process(ShopifyConvert::priceRules($sourcePriceRules['price_rules']));
    }
    ...
    ): Response
    {
        ...
        foreach ($channeledCollection as $channeledPriceRule) {
            if (!$channeledPriceRulesRepository->existsByPlatformIdAndChannel($channeledPriceRule->platformId, $channeledPriceRule->channel)) {
