...
class FacebookMarketingConvertTest extends BaseUnitTestCase
{
    public function testCampaigns(): void
    {
        ...
        $result = FacebookMarketingConvert::campaigns($data, $channeledAccountId);
    ...
    public function testAdsets(): void
    {
        ...
        $result = FacebookMarketingConvert::adsets($data, $channeledAccountId);
    ...
    public function testAds(): void
    {
        ...
        $result = FacebookMarketingConvert::ads($data, $channeledAccountId);
