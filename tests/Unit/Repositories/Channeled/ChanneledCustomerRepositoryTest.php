<?php
    ...
    class ChanneledCustomerRepositoryTest extends BaseUnitTestCase
    {
        ...
        protected function setUp(): void
        {
            ...
            $this->repository = new ChanneledCustomerRepository($this->entityManager, $classMetadata);
        ...
        public function testGetByEmailWithEnumReturnsEntity(): void
        {
            ...
            $channel = $this->getChannelEntity('shopify'); // Enum
            $entity = new Entity();
            ...
            $this->assertEquals(['channelId', $channel->getId()], $parameterCalls[1]);
        }
