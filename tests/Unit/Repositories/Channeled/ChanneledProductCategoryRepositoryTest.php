<?php
    ...
    class ChanneledProductCategoryRepositoryTest extends BaseUnitTestCase
    {
        ...
        protected function setUp(): void
        {
            ...
            $this->repository = new ChanneledProductCategoryRepository($this->entityManager, $classMetadata);
        ...
        public function testGetLastByPlatformId(): void
        {
            ...
            $result = ['id' => 1, 'channel' => $channel->getId()];
            $expected = ['id' => 1, 'channel' => $channel->getId()];
            ...
            $actual = $this->repository->getLastByPlatformId($channel->getName());
        ...
        public function testGetLastByPlatformCreatedAt(): void
        {
            ...
            $actual = $this->repository->getLastByPlatformCreatedAt($channel->getName());
            $this->assertEquals($expected, $actual);
        }
